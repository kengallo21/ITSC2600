...
public class ShoppingListArrayList implements ShoppingListADT {
    ...
    /**
     * Method to add a new entry to the shopping list. If a matching item
     * already exists, the quantities are combined
     *
    ...
    public Grocery find(int index) throws IndexOutOfBoundsException, EmptyCollectionException {
        ...
        if (shoppingList == null) {
            throw new EmptyCollectionException("The Shopping List is empty/null");
        }
     ...
     * @throws ElementNotFoundException if the specified item is not in the
     * shopping list
     */
    @Override
